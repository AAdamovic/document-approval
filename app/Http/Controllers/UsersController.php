...
class UsersController extends Controller {
    ...
    public function create(Request $request) {
        ...
        if (request()->isMethod('post')) {
            ...
            $this->validate(request(), [
                ...
                'role_id' => "required|string|in:$rolesId",
    ...
    public function edit(User $user) {
        ...
        if ((auth()->user()->role->name === \App\User::ROLE_ADMINISTRATOR && auth()->user()->id !== $user->id && $user->role->name === \App\User::ROLE_ADMINISTRATOR ) || (auth()->user()->role->name !== \App\User::ROLE_ADMINISTRATOR && $user->id !== auth()->user()->id )) {
            abort(403, 'Unauthorized action.');
        }
        //get roles for edit
    ...
    public function changePassword(User $user) {
        ...
        // moderator may change only his/her password
        if (auth()->user()->role->name != 'administrator' && auth()->user()->id != $user->id) {
            abort(403, 'Unauthorized action.');
        }
